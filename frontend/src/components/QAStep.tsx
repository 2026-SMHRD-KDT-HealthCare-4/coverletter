...
const QAStep: React.FC = () => {
  const { evaluation, setEvaluation, editedSections, jdContext, setStep, setIsLoading, setError, userId, setDraft } = useStore();
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between mt-10 pt-6 border-t">
        ...
        <button
          disabled={!evaluation.gate_passed}
          onClick={handleDownload}
          className={`px-10 py-4 rounded-xl font-black text-lg flex items-center gap-3 transition-all shadow-xl ${
